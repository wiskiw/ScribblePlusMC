...
import me.chrr.scribble.book.EnhancedTextHandler;
import org.junit.jupiter.api.Test;

import static org.junit.jupiter.api.Assertions.assertEquals;

public class EnhancedMoveCursorByWordsTest {
    ...
    public void testMoveCursorNowhere() {
        ...
        int newPosition = EnhancedTextHandler.moveCursorByWords(text, 0, cursor);
    ...
    public void testMoveCursorToTheLeftCase1() {
        ...
        int newPosition = EnhancedTextHandler.moveCursorByWords(text, -1, cursor);
    ...
    public void testMoveCursorToTheLeftCase9() {
        ...
        int newPosition = EnhancedTextHandler.moveCursorByWords(text, -2, cursor);
    ...
    public void testMoveCursorToTheLeftCase10() {
        ...
        int newPosition = EnhancedTextHandler.moveCursorByWords(text, -Integer.MAX_VALUE, cursor);
